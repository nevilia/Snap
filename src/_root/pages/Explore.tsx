...
import { useGetPosts, useSeachPosts } from '@/lib/react-query/queriesAndMutations'
...
const Explore = () => {
  ...
  const { data: searchedPosts, isFetching: isSearchFetching } = useSeachPosts(debouncedValue)
